...
public class ServerConnector {
    ...
    public String getServerConnectionJson(String address, int port) throws IOException
    {
        ...
        //String commandMessage = createCommandMessage(address, port);
    ...
    /**private String createCommandMessage(String host, int port) throws IOException {
     CharArrayWriter buffer = new ByteArrayOutputStream();

     DataOutputStream command = new DataOutputStream(buffer);
